...
public class CompanyService {
    ...
    public List<BusinessHour> registerBusinessHours(List<BusinessHourDto> businessHourDtos) throws CustomError {
      ...
      List<BusinessHour> savedBusinessHours = businessHourRepository.saveAll(businessHours);
      company.setBusinessHours(savedBusinessHours);
      companyRepository.save(company);

      return savedBusinessHours;
  }
